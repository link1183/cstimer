...
var klmsolver = (function () {
  ...
  function init() {
    ...
    for (var m1 = 0; m1 < 12; m1++) {
      ...
      for (var m2 = 0; m2 < m1; m2++) {
        KiloCubie.KiloMult(
          KiloCubie.moveCube[m1 * 4],
          KiloCubie.moveCube[m2 * 4],
          tmp1,
        );
        KiloCubie.KiloMult(
          KiloCubie.moveCube[m2 * 4],
  ...
  function initPhase1() {
    ...
    mathlib.createPrun(
      ...
      1140 * 27 * 6,
      8,
      comb3FullMove.bind(null, Phase1Move),
      12,
      4,
      5,
    );
    ...
    solv1 = new mathlib.Searcher(
      ...
      function (idx) {
        return Math.max(
          mathlib.getPruning(Phase1Prun, idx[0]),
          mathlib.getPruning(Phase1Prun, idx[1]),
        );
      },
      function (idx, move) {
        var idx1 = [
  ...
  function initPhase2() {
    ...
    mathlib.createPrun(
      ...
      455 * 27 * 6,
      8,
      comb3FullMove.bind(null, Phase2Move),
      6,
      4,
      4,
    );
    ...
    solv2 = new mathlib.Searcher(
      ...
      function (idx) {
        return Math.max(
          mathlib.getPruning(Phase2Prun, idx[0]),
          mathlib.getPruning(Phase2Prun, idx[1]),
        );
      },
      function (idx, move) {
        var idx1 = [
  ...
  function initPhase3() {
    ...
    solv3 = new mathlib.Searcher(
      ...
      function (idx) {
        return Math.max(
          mathlib.getPruning(Phase3Prun, idx[0]),
          mathlib.getPruning(Phase3Prun, idx[1]),
          mathlib.getPruning(Phase3Prun, idx[2]),
        );
      },
      function (idx, move) {
        return [
  ...
  function solveKiloCubie(cc, useSym) {
    ...
    for (var s = 0; s < (useSym ? 12 : 1); s++) {
      KiloCubie.KiloMult3(
        KiloCubie.symCube[KiloCubie.symMulI[0][s * 5]],
        kc0,
        KiloCubie.symCube[s * 5],
        kc1,
      );
      var val0 = phase1Coord.get(kc1, 3);
      KiloCubie.KiloMult3(
        KiloCubie.symCube[KiloCubie.symMulI[0][2]],
        kc1,
        KiloCubie.symCube[2],
        kc2,
      );
    ...
    var sol1 = sol1s[0];
    KiloCubie.KiloMult3(
      KiloCubie.symCube[KiloCubie.symMulI[0][ksym]],
      kc0,
      KiloCubie.symCube[ksym],
      kc1,
    );
    ...
    for (var s = 0; s < (useSym ? 5 : 1); s++) {
      KiloCubie.KiloMult3(
        KiloCubie.symCube[KiloCubie.symMulI[0][s]],
        kc0,
        KiloCubie.symCube[s],
        kc1,
      );
      ...
      KiloCubie.KiloMult3(
        KiloCubie.symCube[KiloCubie.symMulI[0][1]],
        kc1,
        KiloCubie.symCube[1],
        kc2,
      );
    ...
    KiloCubie.KiloMult3(
      KiloCubie.symCube[KiloCubie.symMulI[0][6]],
      kc0,
      KiloCubie.symCube[6],
      kc1,
    );
    ...
    KiloCubie.KiloMult3(
      KiloCubie.symCube[KiloCubie.symMulI[0][29]],
      kc0,
      KiloCubie.symCube[29],
      kc1,
    );
    ...
    DEBUG &&
      console.log(
        "[kilo] total length: ",
        sol1.length + sol2.length + sol3.length,
      );
