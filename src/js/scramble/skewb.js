(function () {
  ...
  function getScrambleIvy(type) {
    ...
    do {
      ...
      (perm == 0 && twst == 0) ||
      solvivy.search([perm, twst], 0, lim) != null
    );
    return solvivy.toStr(
      solvivy.search([perm, twst], maxl).reverse(),
      "RLDB",
      "' ",
    );
  }

  scrMgr.reg(["skbo", "skbso", "skbnb"], getScramble)(
    ["ivyo", "ivyso"],
    getScrambleIvy,
  );
})();
