...
(function (rn, rndEl, mega) {
  ...
  function PolyScrambler(puzzle, validMoves, move2str) {
    ...
    DEBUG &&
      console.log("[scramble] Poly Scramble |G|=", this.solv.sgsG.size());
  }
  ...
  PolyScrambler.prototype.getScramble = function (minLen, maxLen) {
    ...
    do {
      ...
      solution = sol
        .map((mvpow) => this.move2str(this.moves[mvpow[0]], mvpow[1]))
        .join(" ");
    ...
    switch (type) {
      ...
      case "mgmo": // Megaminx (old style)
        return adjScramble(
          ...
          [
            0x554, 0xaa8, 0x691, 0x962, 0xa45, 0x58a, 0x919, 0x626, 0x469,
            0x896, 0x1a5, 0x25a,
          ],
          len,
          minxsuff,
      ...
      case "helicv":
        return adjScramble(
          ...
          [
            0x09a, 0x035, 0x06a, 0x0c5, 0x303, 0x606, 0xc0c, 0x909, 0xa90,
            0x530, 0xa60, 0x5c0,
          ],
          len,
        );
      case "heli2x2":
        ret = adjScramble(
          ...
          [
            0x2709000, 0x1703000, 0x3506000, 0x330c000, 0x2e90000, 0x1e30000,
            0x3c60000, 0x3ac0000, 0x0f11000, 0x1d22000, 0x3944000, 0x2b88000,
            0x0700103, 0x1500206, 0x310040c, 0x2300809, 0x0e00130, 0x1c00260,
            0x38004c0, 0x2a00890, 0x360ff0f, 0x2d999bb, 0x1b33377, 0x36f0ff0,
            0x2d666ee, 0x1bcccdd,
          ],
          len,
          null,
      ...
      case "heli2x2g":
        ...
        for (var i = 0; i < len; i++) {
          ...
          for (var j = 0; j < 3; j++) {
            line.push(
              "URF".charAt(facePerm[j]) + mathlib.rndEl([" ", "2", "'"]),
            );
          }
          line.push("");
      ...
      case "333noob": // 3x3x3 for noobs
        ret = mega(SCRAMBLE_NOOBST, SCRAMBLE_NOOBSS.split("|"), len).replace(
          /t/,
          "T",
        );
