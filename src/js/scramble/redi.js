var redi = (function () {
  ...
  function initRedi() {
    ...
    solvRedi1 = new mathlib.Searcher(
      null,
      function (idx) {
        return Math.max(
  ...
  function solveDino(ep, minl) {
    var idx = [getEdgeComb(0, ep), getEdgeComb(4, ep), getEdgeComb(8, ep)];
  ...
  scrMgr.reg("rediso", getRandomScramble)("dinoo", getRandomScramble)(
    "dinoso",
    getRandomScramble,
  );
