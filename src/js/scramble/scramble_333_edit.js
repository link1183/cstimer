...
var scramble_333 = (function (getNPerm, setNPerm, getNParity, rn, rndEl) {
  ...
  scrMgr.reg("333", getRandomScramble)("333fm", getFMCScramble)(
    "edges",
    getEdgeScramble,
  )("corners", getCornerScramble)("333custom", getCustomScramble, [
    customfilter,
    customprobs,
  ])("ll", getLLScramble)("lsll2", getLSLLScramble, [
    f2lfilter,
    f2lprobs,
    ...
    "vls",
    getVLSScramble,
    [vlsfilter, vlsprobs, getVLSImage],
    ...
    "coll",
    getCOLLScramble,
    [cofilter, coprobs, getCOLLImage.bind(null, "D")],
    ...
    "half",
    subsetScramble.bind(null, ["U2", "R2", "F2", "D2", "L2", "B2"]),
  )("333drud", subsetScramble.bind(null, ["U", "R2", "F2", "D", "L2", "B2"]))(
    "3gen_F",
    subsetScramble.bind(null, ["U", "R", "F"]),
  )("3gen_L", subsetScramble.bind(null, ["U", "R", "L"]))(
    "2gen",
    subsetScramble.bind(null, ["U", "R"]),
  )("2genl", subsetScramble.bind(null, ["U", "L"]))(
    "RrU",
    subsetScramble.bind(null, ["R", "Rw", "U"]),
  )("roux", subsetScramble.bind(null, ["M", "U"]))(
    "mt3qb",
    getMehta3QBScramble,
  )("mteole", getMehtaEOLEScramble)("mttdr", getMehtaTDRScramble)(
    "mt6cp",
    getMehta6CPScramble,
  )("mtl5ep", getMehtaL5EPScramble)("mtcdrll", getMehtaCDRLLScramble)(
    "easyc",
    getEasyCrossScramble,
  )("easyxc", getEasyXCrossScramble)("eoline", getEOLineScramble)(
    "eocross",
    getEOCrossScramble,
  );
