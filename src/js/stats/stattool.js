    ...
    function updateInfo() {
      ...
      s.push(
        '<span class="click" data="tt">' +
          hlstr[4].replace(
            "%d",
            times_stats_table.timesLen -
              numdnf +
              "/" +
              times_stats_table.timesLen,
          ) +
          ", " +
          hlstr[9].replace("%v", prettyFunc[1](sessionmean)) +
          "</span>\n",
      );
      s.push(
      ...
      s.push(
        " | " +
          ...
          prettyFunc[0](times_stats_table.worstTime) +
          "</span>\n",
      );
      var hasTable = false;
      var tableHead =
        ...
        if (times_stats_table.timesLen >= size) {
          ...
          s.push(
            '<td><span class="click" data="c' +
              ...
              " (σ=" +
              stats.trim(times_stats_table.lastAvg[j][1], 2) +
              ")</span></td>",
          );
          s.push(
            '<td><span class="click" data="b' +
              ...
              " (σ=" +
              stats.trim(times_stats_table.bestAvg(j, 1), 2) +
              ")</span></td></tr>",
          );
        }
      }
