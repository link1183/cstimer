var trend = execMain(
  function (kpretty) {
    var canvas = $('<canvas style="margin-bottom:-0.4em"/>'),
      ctx;
    ...
    function updateTrend() {
      ...
      if (timesLen > len1) {
        x = [];
        y = [];
        var ao5 = times_stats_list.runAvgMean(
          0,
          timesLen,
          len1,
          stat1 > 0 ? undefined : 0,
      ...
      if (timesLen > len2) {
        x = [];
        y = [];
        var ao12 = times_stats_list.runAvgMean(
          0,
          timesLen,
          len2,
          stat2 > 0 ? undefined : 0,
      ...
      for (var i = plotmin; i <= plotmax; i += diff) {
        ...
        plot(
          [offtx, offtx + amptx],
          [(i - plotmin) / ploth, (i - plotmin) / ploth],
          "#ccc",
        );
      }
      plot(
        [offtx, offtx + amptx, offtx + amptx, offtx, offtx],
        [offty, offty, offty + ampty, offty + ampty, offty],
        "#000",
      );
    }
