(function () {
  ...
  function bindKeyMap(keyMaps, twisty) {
    ...
    twisty.getAllMoves = function (puzzle, moveActions, layerActions) {
      var ret = [];
      var moveSets = {};
      for (var key in moveActions) {
        // each move might be adjusted by layer actions
        ...
        for (
          maxLayer = ~~m[1];
          puzzle.getTwistyIdx(maxLayer + 1 + m[2]) != -1;
          maxLayer++
        ) {}
        var layerIncs = {};
        for (var key2 in layerActions) {
          // cache the effective of all layerActions
        ...
        do {
          ...
          for (var layer in layers) {
            for (var layerInc in layerIncs) {
              var newLayer =
                "" + Math.max(1, Math.min(maxLayer, ~~layer + ~~layerInc));
              if (!(newLayer in layers)) {
                layers[newLayer] = 1;
                moveSets[newLayer + m[2] + move[1]] = [
                  newLayer + m[2],
                  move[1],
                ];
                isUpdated = true;
  ...
  twistyjs.registerTwisty("pyr", function (scene, param) {
    ...
    var twisty = createCubeTwisty(scene, param);
    bindKeyMap(
      "I:R K:R' W:B O:B' S:b L:b' D:L E:L' J:U F:U' H:u G:u' ;:[u] A:[u'] U:r M:r' R:l' V:l T:[l'] Y:[r] N:[r'] B:[l] P:[b'] Q:[b] 61:u2 62:B 63:R 64:[u2] 65:[u] 67:F2 69:F 41:L' 42:B' 43:u2' 45:[u'] 46:[u2'] 47:F' 49:F2' 31:U2 32:U 34:u2 35:u 36:R' 37:[f'] 39:R2' 12:U' 13:U2' 14:L 15:u' 16:u2' 17:L2 19:[f] 91:[f'] 92:B2 93:R2 94:F2' 95:r 96:F' 97:D2' 98:D' 73:[f] 72:B2' 71:L2' 76:F2 75:l' 74:F 79:D2 78:D 21:U 23:U' 24:B 25:[r'] 26:B' 27:B2 28:[r2'] 29:B2' 51:u 52:[r] 53:u' 54:[u] 56:[u'] 57:l 58:[r'] 59:r' 82:[r2] 85:[r] 87:D' 89:D",
      twisty,
    );
    return twisty;
  });
  ...
  twistyjs.registerTwisty("mpyr", function (scene, param) {
    ...
    var twisty = createCubeTwisty(scene, param);
    bindKeyMap(
      "I:R K:R' W:B O:B' S:Bw L:Bw' D:L E:L' J:U F:U' H:Uw G:Uw' ;:[u] A:[u'] U:Rw M:Rw' R:Lw' V:Lw T:[l'] Y:[r] N:[r'] B:[l] P:[b'] Q:[b] 5:u' 6:u X:b .:b' 1:l 2:l' 9:r 0:r'",
      twisty,
    );
    return twisty;
  });
  ...
  twistyjs.registerTwisty("redi", function (scene, param) {
    ...
    var twisty = createCubeTwisty(scene, param);
    bindKeyMap(
      "I:R K:R' E:L' D:L H:F G:F' J:B F:B' L:f' S:f ;:y A:y' U:r M:r' R:l' V:l T:x Y:x N:x' B:x' P:z Q:z'",
      twisty,
    );
    return twisty;
  });
  ...
  twistyjs.registerTwisty("fto", function (scene, param) {
    ...
    var twisty = createCubeTwisty(scene, param);
    bindKeyMap(
      "I:R K:R' D:L E:L' J:U F:U' H:F G:F' S:D L:D' W:B O:B' 8:BR ,:BR' C:BL 3:BL' U:Rw M:Rw' R:Lw' V:Lw Y:[R] N:[R'] T:[L'] B:[L] ;:[U] A:[U'] P:T Q:T' 62:BR 63:R 64:[U2] 65:[U] 67:F2 69:F 41:L' 42:BR' 45:[U'] 46:[U2'] 47:F' 49:F2' 31:U2 32:U 36:R' 37:[F'] 39:R2' 12:U' 13:U2' 14:L 17:L2 19:[F] 91:[F'] 92:BR2 93:R2 94:F2' 96:F' 97:D2' 98:D' 73:[F] 72:BR2' 71:L2' 76:F2 74:F 79:D2 78:D 21:U 23:U' 24:BR 25:[R'] 26:BR' 27:BR2 28:[R2'] 29:BR2' 52:[R] 54:[U] 56:[U'] 58:[R'] 82:[R2] 85:[R] 87:D' 89:D",
      twisty,
    );
    return twisty;
  });
  ...
  twistyjs.registerTwisty("dmd", function (scene, param) {
    ...
    var twisty = createCubeTwisty(scene, param);
    bindKeyMap(
      "I:R K:R' D:L E:L' J:U F:U' H:F G:F' S:D L:D' W:B O:B' 8:BR ,:BR' C:BL 3:BL' Y:[R] N:[R'] T:[L'] B:[L] ;:[U] A:[U'] P:T Q:T' 62:BR 63:R 64:[U2] 65:[U] 67:F2 69:F 41:L' 42:BR' 45:[U'] 46:[U2'] 47:F' 49:F2' 31:U2 32:U 36:R' 37:[F'] 39:R2' 12:U' 13:U2' 14:L 17:L2 19:[F] 91:[F'] 92:BR2 93:R2 94:F2' 96:F' 97:D2' 98:D' 73:[F] 72:BR2' 71:L2' 76:F2 74:F 79:D2 78:D 21:U 23:U' 24:BR 25:[R'] 26:BR' 27:BR2 28:[R2'] 29:BR2' 52:[R] 54:[U] 56:[U'] 58:[R'] 82:[R2] 85:[R] 87:D' 89:D",
      twisty,
    );
    return twisty;
  });
  ...
  twistyjs.registerTwisty("heli2x2", function (scene, param) {
    ...
    var twisty = createCubeTwisty(scene, param);
    bindKeyMap(
      "I:UR K:UR' W:F' O:F S:U' L:U X:R .:R' D:UL E:UL' J:UB F:UB' H:UF G:UF' U:URF M:URF' R:UFL' V:UFL ;:[U] A:[U'] T:[L'] Y:[R] N:[R'] B:[L] P:[F] Q:[F']",
      twisty,
    );
    return twisty;
  });
  ...
  twistyjs.registerTwisty("crz3a", function (scene, param) {
    ...
    var twisty = createCubeTwisty(scene, param);
    bindKeyMap(
      "I:R K:R' W:B O:B' S:D L:D' D:L E:L' J:U F:U' H:F G:F' ;:y A:y' T:x Y:x N:x' B:x' P:z Q:z' 62:B 63:R 64:y2 65:y 67:F2 69:F 41:L' 42:B' 45:y' 46:y2' 47:F' 49:F2' 31:U2 32:U 36:R' 37:z' 39:R2' 12:U' 13:U2' 14:L 17:L2 19:z 91:z' 92:B2 93:R2 94:F2' 96:F' 97:D2' 98:D' 73:z 72:B2' 71:L2' 76:F2 74:F 79:D2 78:D 21:U 23:U' 24:B 25:x' 26:B' 27:B2 28:x2' 29:B2' 52:x 54:y 56:y' 58:x' 82:x2 85:x 87:D' 89:D",
      twisty,
    );
    return twisty;
  });
  ...
  function createCubeTwisty(twistyScene, twistyParameters) {
    ...
    puzzle.enumFacesPolys(function (face, p, poly, idx) {
      ...
      var transformationMatrix = twistyjs
        .axify(
          puzzle.faceUVs[face][0],
          puzzle.faceUVs[face][1],
          puzzle.facePlanes[face].norm,
        )
    ...
    function animateMoveCallback(twisty, currentMove, moveProgress, moveStep) {
      ...
      rots.setRotationAxis(
        twistyPlane.norm,
        (-moveStep * Math.TAU * currentMove[1]) /
          puzzle.twistyDetails[moveIdx][1],
      );
